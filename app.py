...
######################################################### SINGLE TRAININGS ##################################################
        if sku == 'Fusion Apps Foundation':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus10nfunda'
        ...
        if sku == 'Fusion HCM Core Functional':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus10nt3ch'
        ...
        if sku == 'Fusion Talent Management':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'talent$123'
        ...
        if sku == 'Fusion Benefits':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Kp$ben$8'
        ...
        if sku == 'Fusion Payroll':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'K81$$kris$2'
        ...
        if sku == 'Oracle Fusion Fast Formula Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'F4$tf0'
        ...
        if sku == 'Fusion Compensation Workbench':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'com$san545'
        ...
        if sku == 'Oracle Fusion HCM Approval Management':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'H$mA3pv'
        ...
        if sku == 'Oracle Time & Labour (OTL)':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Ok5t$Ld'
        ...
        if sku == 'EBS HCM Experts':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'h5zGM8'
        ...
        if sku == 'Fusion Procurement':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus10nfundapr0c'
        ...
        if sku == 'Fusion HCM technical Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'hc$$tec$8'
        ...
        if sku == 'Fusion Accounting Hub':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'f4$hmah'
        ...
        if sku == 'Fusion Procure to Pay':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'p2$$p562'
        ...
        if sku == 'Fusion Applications Installation & Patching R9':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'A$3er4'
        ...
        if sku == 'Development In Fusion Applications':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'D3v$3ws3'
        ...
        if sku == 'Fusion Financials':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus$f1n'
        ...
        #     isFusion = True
        #     isPackage = False
        #     single_training_password = 'BI$Kp$sa'
        ...
        if sku == 'Fusion Account Receivables':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Kp$fin$5'
        ...
        if sku == 'Fusion e-biz Tax':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'F$tA4xJ'
        ...
        if sku == 'Oracle Apps DBA Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'A$pd3a'
        ...
        if sku == 'Oracle Subledger Accounting':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'S$$1a$8'
        ...
        if sku == 'Oracle EBS Financials Functional R12':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'R1$ts$0m'
        ...
        if sku == 'OAF Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = '0af$4nna'
        ...
        if sku == 'ORACLE E-BUSINESS TAX':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'E$b8i3s'
        ...
        if sku == 'Oracle Demantra':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'De$t3$5'
        ...
        if sku == 'ORACLE R12 HRMS PAYROLL TRAINING':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'R$hr3m5s'
        ...
        if sku == 'Oracle Implement Configurator':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'E$co4n'
        ...
        if sku == 'Oracle R12 Project Accounting':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'P4r$12s'
        ...
        if sku == 'Oracle R12 - Advanced Supply Chain Planning (ASCP) Fundamentals':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'Sk4CMz'
        ...
        if sku == 'Oracle Business Intelligence Applications Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = '0b1$562'
        ...
        #     isFusion = True
        #     isPackage = False
        #     single_training_password = 'O$b6ei3'
        ...
        if sku == 'Oracle ADF Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Ad$ey31'
        ...
        if sku == 'Oracle BPM - Business Process Management Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'B$pm3#'
        ...
        if sku == 'Oracle Data Integrator ODI':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'O$di12cg'
        ...
        if sku == 'Oracle MAF':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'M4$fni'
        ...
        if sku == 'Java, XML and Webservices':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'jAVa$1'
        ...
        if sku == 'Oracle SQL and PL/SQL Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'S2q3lp'
        ...
        if sku == 'Financial Integration':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'K4i$$f23'
        ...
        if sku == 'Fusion Security':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'F$s2ec5yt'
        ...
        if sku == 'Fusion Financials Approval':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'f$am2E'
        ...
        if sku == 'Integration Cloud Service':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'I$s2ciY'
        ...
        if sku == 'Oracle Sales Cloud Extensibility':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Ow4C7Lh'
        ...
        if sku == 'Fusion Account Payables':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus10npay3bl3s'
        ...
        if sku == 'Fusion General Ledger':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fus1$$g!'
        ...
        #     isFusion = True
        #     isPackage = False
        #     single_training_password = 'F3apHT'
        ...
        if sku == 'Oracle Fusion Project Portfolio Management':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'pp$ed5'
        ...
        if sku == 'Oracle Ebusiness Suite Fundamentals':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'E$bF3Kq'
        ...
        if sku == 'Oracle R12 iProcurement':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'riP5oc$2'
        ...
        if sku == 'Oracle Service Contract Fundamentals':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'C2ne6vk'
        ...
        #     isFusion = False
        #     isPackage = False
        #     single_training_password = 'd7FCNg'
        ...
        if sku == 'Oracle Transportation Management':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'oWm7F8'
        ...
        if sku == 'IDM Foundation':
            ...
            isFusion = True
            isPackage = False
            single_training_password = '0im$m25'
        ...
        if sku == 'Oracle Access Manager':
            ...
            isFusion = True
            isPackage = False
            single_training_password = '0am$3h3'
        ...
        if sku == 'Weblogic Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'W3b$0g'
        ...
        if sku == 'Oracle Entitlement Server Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'O3s$te3'
        ...
        if sku == 'Oracle Fusion MiddleWare 12c Administration':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'fm$1d5c'
        ...
        if sku == 'Oracle GoldenGate':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Go$di52'
        ...
        if sku == 'Oracle Database 12c: New Features for Administrators Ed2':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'D$a2t6a'
        ...
        if sku == 'Oracle Database : Data Guard Administration':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'D$2ag6d1w'
        ...
        if sku == 'Oracle R12 Approvals Management Engine (AME)':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'A$m2e4s'
        ...
        if sku == 'Oracle ERP Development':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'E$r2p3z8'
        ...
        #     isFusion = False
        #     isPackage = False
        #     single_training_password = 'O$2c9w7o'
        ...
        if sku == 'Oracle BI Publisher':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'B1p$red'
        ...
        if sku == 'EBS Techno-Functional Package':
            ...
            isFusion = False
            isPackage = False
            single_training_password = 'A$b3sd4m'
        ...
        if sku == 'Oracle Taleo Training':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'T$a2l1i49'
        ...
        #     isFusion = True
        #     isPackage = False
        #     single_training_password = 'T$Ij5de7K'
        ...
        #     isFusion = False
        #     isPackage = False
        #     single_training_password = 'E$b2ta6'
        ...
        if sku == 'Siebel open UI':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 's1b$le8'
        ...
        if sku == 'Hyperion Financial Management':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'HF$21m'
        ...
        if sku == 'Fusion Hyperion Planning':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'Hy9$u$8u'
        ...
        if sku == 'Mastering Hyperion Calculation Manager with Essbase and Planning':
            ...
            isFusion = True
            isPackage = False
            single_training_password = 'H$e5ys2p'
